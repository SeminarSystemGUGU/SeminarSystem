        ...
        for(let i=0;i<teamConflict.length;i++){
          ...
          this.$axios({
            ...
            data: {
              ...
              teamStartTime: this.$data.formTeamRule.teamStartDate,
              teamEndTime: this.$data.formTeamRule.teamEndDate,
              maxMember: this.$data.formTeamRule.teamMaxNum,
              minMember: this.$data.formTeamRule.teamMinNum,
